...
export const Formats: FormatList = [
	...
	},
	{
		...
		restricted: [
			'Dynamic Punch', 'Flail', 'Flip Turn', 'Fury Cutter', 'Grass Knot', 'Grassy Glide', 'Hard Press', 'Heavy Slam', 'Heat Crash', 'Electro Ball',
			'Gyro Ball', 'Inferno', 'Low Kick', 'Nuzzle', 'Power Trip', 'Reversal', 'Spit Up', 'Stored Power', 'Tera Blast', 'Volt Switch', 'Weather Ball',
			'Zap Cannon',
		],
		onValidateTeam(team) {
		...
		onModifyMove(move, pokemon, target) {
			...
			if (move.category !== 'Status' && forte) {
				...
				const VALID_PROPERTIES = [
					...
					'ignoreAbility', 'ignoreAccuracy', 'ignoreDefensive', 'ignoreEvasion', 'mindBlownRecoil', 'noDamageVariance',
