...
        ],
	...
	},
	{
		...
		banlist: [
			...
			'Wonder Guard', 'Buzzwole', 'Clefable', 'Conkeldurr', 'Dragapult', 'Dragonite', 'Kartana', 'Melmetal',
			'Pangoro', 'Perrserker', 'Pheromosa', 'Regigigas', 'Shedinja', 'Tapu-Lele', 'Urshifu', 'Victini', 'Zamazenta-Crowned',
