...
        ],
	...
	},
	{
		...
		mod: 'gen8',
		ruleset: ['Standard', 'Dynamax Clause', 'Pokebilities Rule', '!Obtainable Abilities', '2 Ability Clause'],
		banlist: [
			...
			'Imposter', 'Innards Out', 'Intrepid Sword', 'Libero', 'Moody', 'Neutralizing Gas', 'Parental Bond', 'Poison Heal',
			'Prankster', 'Protean', 'Pure Power', 'Shadow Tag', 'Simple', 'Stakeout', 'Speed Boost', 'Tinted Lens', 'Water Bubble',
			'Wonder Guard', 'Blacephalon', 'Buzzwole', 'Clefable', 'Conkeldurr', 'Dragapult', 'Dragonite', 'Kartana', 'Melmetal',
			'Pangoro', 'Perrserker', 'Pheromosa', 'Rillaboom', 'Regigigas', 'Shedinja', 'Tapu-Lele', 'Urshifu', 'Victini', 'Zamazenta-Crowned',
			'Regenerator + Wimpod', 'Wimp Out', 'Emergency Exit', 'Drought + Bellossom', 'Drought + Bulbasaur', 'Drought + Cherubi',
			'Drought + Cottonee', 'Drought + Exeggcute', 'Drought + Exeggutor', 'Drought + Gloom', 'Drought + Ivysaur',
			'Drought + Leafeon', 'Drought + Lilligant', 'Drought + Maractus', 'Drought + Nuzleaf', 'Drought + Oddish',
			'Drought + Petilil', 'Drought + Seedot', 'Drought + Shiftry', 'Drought + Tangela', 'Drought + Tangrowth',
			'Drought + Venusaur', 'Drought + Vileplume', 'Drought + Whimsicott', 'Desolate Land + Bellossom',
			'Desolate Land + Bulbasaur', 'Desolate Land + Cherubi', 'Desolate Land + Cottonee', 'Desolate Land + Exeggcute',
			'Desolate Land + Exeggutor', 'Desolate Land + Gloom', 'Desolate Land + Ivysaur', 'Desolate Land + Leafeon',
			'Desolate Land + Lilligant', 'Desolate Land + Maractus', 'Desolate Land + Nuzleaf', 'Desolate Land + Oddish',
			'Desolate Land + Petilil', 'Desolate Land + Seedot', 'Desolate Land + Shiftry', 'Desolate Land + Tangela',
			'Desolate Land + Tangrowth', 'Desolate Land + Venusaur', 'Desolate Land + Vileplume', 'Desolate Land + Whimsicott',
			'Chlorophyll + Groudon', 'Chlorophyll + Ninetales', 'Chlorophyll + Torkoal', 'Chlorophyll + Vulpix', 'Drizzle + Anorith',
			'Drizzle + Armaldo', 'Drizzle + Arrokuda', 'Drizzle + Barraskewda', 'Drizzle + Beartic', 'Drizzle + Carracosta',
			'Drizzle + Chewtle', 'Drizzle + Drednaw', 'Drizzle + Feebas', 'Drizzle + Goldeen', 'Drizzle + Golduck', 'Drizzle + Horsea',
			'Drizzle + Kabuto', 'Drizzle + Kabutops', 'Drizzle + Kingdra', 'Drizzle + Lombre', 'Drizzle + Lotad', 'Drizzle + Ludicolo',
			'Drizzle + Magikarp', 'Drizzle + Mantine', 'Drizzle + Mantyke', 'Drizzle + Omanyte', 'Drizzle + Omastar', 'Drizzle + Palpitoad',
			'Drizzle + Poliwag', 'Drizzle + Poliwhirl', 'Drizzle + Poliwrath', 'Drizzle + Psyduck', 'Drizzle + Qwilfish',
			'Drizzle + Relicanth', 'Drizzle + Seaking', 'Drizzle + Seismitoad', 'Drizzle + Tirtouga', 'Drizzle + Tympole',
			'Primordial Sea + Anorith', 'Primordial Sea + Armaldo', 'Primordial Sea + Arrokuda', 'Primordial Sea + Barraskewda',
			'Primordial Sea + Beartic', 'Primordial Sea + Carracosta', 'Primordial Sea + Chewtle', 'Primordial Sea + Drednaw',
			'Primordial Sea + Feebas', 'Primordial Sea + Goldeen', 'Primordial Sea + Golduck', 'Primordial Sea + Horsea',
			'Primordial Sea + Kabuto', 'Primordial Sea + Kabutops', 'Primordial Sea + Kingdra', 'Primordial Sea + Lombre',
			'Primordial Sea + Lotad', 'Primordial Sea + Ludicolo', 'Primordial Sea + Magikarp', 'Primordial Sea + Mantine',
			'Primordial Sea + Mantyke', 'Primordial Sea + Omanyte', 'Primordial Sea + Omastar', 'Primordial Sea + Palpitoad',
			'Primordial Sea + Poliwag', 'Primordial Sea + Poliwhirl', 'Primordial Sea + Poliwrath', 'Primordial Sea + Psyduck',
			'Primordial Sea + Qwilfish', 'Primordial Sea + Relicanth', 'Primordial Sea + Seaking', 'Primordial Sea + Seismitoad',
			'Primordial Sea + Tirtouga', 'Primordial Sea + Tympole', 'Swift Swim + Kyogre', 'Swift Swim + Pelipper', 'Swift Swim + Politoed',
			'Sand Stream + Dracovish', 'Sand Stream + Dracozolt', 'Sand Stream + Drilbur', 'Sand Stream + Excadrill', 'Sand Stream + Herdier',
			'Sand Stream + Lycanroc', 'Sand Stream + Sandshrew', 'Sand Stream + Sandslash', 'Sand Stream + Stoutland', 'Sand Rush + Gigalith',
			'Sand Rush + Hippopotas', 'Sand Rush + Hippowdon', 'Sand Rush + Tyranitar', 'Slush Rush + Abomasnow', 'Slush Rush + Amaura',
			'Slush Rush + Aurorus', 'Slush Rush + Ninetales-Alola', 'Slush Rush + Snover', 'Slush Rush + Vanilluxe', 'Slush Rush + Vulpix-Alola',
			'Snow Warning + Arctovish', 'Snow Warning + Arctozolt', 'Snow Warning + Beartic', 'Snow Warning + Cubchoo',
			'Snow Warning + Sandshrew-Alola', 'Snow Warning + Sandslash-Alola', 'RaichuAlola + Electric Surge', 'Tapu-Koko + Surge Surfer',
			'Shadow Shield + Amoonguss', 'Shadow Shield + Audino', 'Shadow Shield + Corsola', 'Shadow Shield + Duosion',
			'Shadow Shield + Eldegoss', 'Shadow Shield + Foongus', 'Shadow Shield + Gossifleur', 'Shadow Shield + Ho-Oh',
			'Shadow Shield + Mareanie', 'Shadow Shield + Mienfoo', 'Shadow Shield + Mienshao', 'Shadow Shield + Reuniclus',
			'Shadow Shield + Slowbro', 'Shadow Shield + Slowking', 'Shadow Shield + Slowpoke', 'Shadow Shield + Solosis',
			'Shadow Shield + Tangela', 'Shadow Shield + Tangrowth', 'Shadow Shield + Tornadus-Therian', 'Shadow Shield + Toxapex',
			'Multiscale + Amoonguss', 'Multiscale + Audino', 'Multiscale + Corsola', 'Multiscale + Duosion', 'Multiscale + Eldegoss',
			'Multiscale + Foongus', 'Multiscale + Gossifleur', 'Multiscale + Ho-Oh', 'Multiscale + Mareanie', 'Multiscale + Mienfoo',
			'Multiscale + Mienshao', 'Multiscale + Reuniclus', 'Multiscale + Slowbro', 'Multiscale + Slowking', 'Multiscale + Slowpoke',
			'Multiscale + Solosis', 'Multiscale + Tangela', 'Multiscale + Tangrowth', 'Multiscale + Tornadus-Therian', 'Multiscale + Toxapex',
			'Amoonguss ++ Audino ++ Corsola ++ Duosion ++ Eldegoss ++ Foongus ++ Gossifleur ++ Ho-Oh ++ Mareanie ++ Mienfoo ++ Mienshao ++ Reuniclus ++ Slowbro ++ Slowking ++ Slowpoke ++ Solosis ++ Tangela ++ Tangrowth ++ Tornadus-Therian ++ Toxapex ++ Regenerator > 2',
...
    },
	...
	{
		name: "[Gen 8 MIXT] STAB and Mega",
		desc: `Mega Stones and Primal Orbs can be used on almost any Pok&eacute;mon with no Mega Evolution limit.`,

		mod: 'genmixt',
		ruleset: ['STABmons Move Legality', 'Obtainable', 'Species Clause', 'Nickname Clause', 'OHKO Clause', 'Evasion Moves Clause', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod', 'Overflow Stat Mod', 'Dynamax Clause', 'Sleep Clause Mod', 'Endless Battle Clause'],
		banlist: [
			'Kyogre', 'Zacian',
